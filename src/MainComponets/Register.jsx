...
function Register() {
  ...
  // donors for carousel
  const donors = [
    { name: "Adaora K.", quote: "Your kindness fuels our mission every day.", img: "https://i.pravatar.cc/61" },
    { name: "Emeka O.", quote: "Giving brings hope to those in need.", img: "https://i.pravatar.cc/62" },
    { name: "Fatima L.", quote: "Together, we create a brighter tomorrow.", img: "https://i.pravatar.cc/63" },
    { name: "David U.", quote: "Every act of kindness counts.", img: "https://i.pravatar.cc/64" },
    { name: "Ngozi P.", quote: "Compassion is the foundation of change.", img: "https://i.pravatar.cc/65" },
  ];
      ...
      >
        ...
        >
          ...
          <p className="text-gray-300 mt-3 max-w-md">
            Be part of a community bringing hope, joy, and real change through
            giving. Every signup moves a life forward.
          </p>
        ...
        >
          ...
          <p className="text-gray-600 text-center mb-6">
            Start making an impact with GiveBloom.
          </p>
